...
export default function AboutPage() {
  return (
    <div className="container mx-auto p-6 flex flex-col space-y-6 min-h-0 h-full">
      <header className="border-b border-border pb-3">
        <h1 className="text-xl font-semibold tracking-tight">About KourGrid</h1>
        <p className="text-sm text-muted-foreground">Mauritius Stock Exchange Analytics Platform</p>
      </header>

      <div className="flex-grow grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-0 overflow-y-auto pr-2 scrollbar-thin">
